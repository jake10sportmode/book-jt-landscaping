window.BookProServices = {
  ...
  initDefaults() {
    const landscapingDefaults = [
      ...
      { id: 'service-yearlong', name: 'Year-Long Lawn Service', description: 'Weekly cut, blow, edge, and weed whip. Edging every other week.', price: 30, duration: 30, category: 'Maintenance', color: '#6366f1', icon: '🏡', requiresContract: false },
